...
const props = defineProps({
    servicesCategories: Object,
});

const categories = computed(() => props.servicesCategories.data);

function deleteAction(categoryId) {
    router.delete(route('dashboard.category.destroy', categoryId));
}
</script>
    ...
    <AuthenticatedLayout>
        ...
        <div class="overflow-auto m-5 mx-auto">
            <div class="flex flex-row justify-end">
                <Link class="px-4 py-2 bg-black text-white rounded-3xl flex flex-row gap-2" :href="route('dashboard.category.create')">
            ...
            <table class="w-full text-sm text-gray-800 table-auto font-bold">
                ...
                <tbody class="divide-y-8 divide-gray-100 border-gray-100">
                    <tr v-for="category in categories" class="bg-white" style="border-radius: 10px">
                        <td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center gap-4">
                                <div>
                                    <Link :href="route('dashboard.category.services.index', category.id)">
                                        <svg
                                ...
                                <div>
                                    <Link :href="route('dashboard.category.edit', category.id)">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                ...
                                <div>
                                    <button @click="deleteAction(category.id)">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
